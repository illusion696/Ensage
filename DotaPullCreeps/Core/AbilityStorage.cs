...
namespace SupportsRage.Core
{
    ...
    {
        public static ProtectData[] _LowSkills = {
            new ProtectData
            {
        ...
        public static ProtectData[] _MediumSkills = {
            new ProtectData
            {
        ...
        public static ProtectData[] _DangerSkills = {
            new ProtectData
            {
        ...
        public static ProtectData[] _UltSkills = {
            new ProtectData
            {
